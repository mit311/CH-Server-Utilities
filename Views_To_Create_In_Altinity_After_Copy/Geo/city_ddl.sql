CREATE VIEW info_test.city ON CLUSTER 'reporting-dev01'
(
 city String,
 region String,
...
WITH CTE AS
 ...
 FROM info_test.location_data AS city
 INNER JOIN info_test.location_data AS state ON city.sub_location1 = state.location
 WHERE (city.location_type_id = 6) AND (state.location_type_id = 5)
 )
SELECT
 city,
 region,
